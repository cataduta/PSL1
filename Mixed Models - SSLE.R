...
### FOR GLE ANALYSES, IT WILL LOOK SOMETHING LIKE THIS:
...
# GLE_Cerebellum dataset: continuous, positive response variable with skewness (long right tail); log-normal distribution
# Gamma and Inverse Gaussian families with log link function should, theoretically, provide the best fit for the data
...
GLMER_model_GLE_Cerebellum_gamma_log_1 <- glmer(Stimulus.RT ~ StimCondition + (1|Subject), data = GLE_Cerebellum, nAGQ = 0, family = Gamma(link = "log"))
GLMER_model_GLE_Cerebellum_gamma_log_1
car::Anova(GLMER_model_GLE_Cerebellum_gamma_log_1a, type=3)

GLMER_model_GLE_Cerebellum_invgauss_log_1 <- glmer(Stimulus.RT ~ StimCondition + (1|Subject), data = GLE_Cerebellum, nAGQ = 0, family = inverse.gaussian(link = "log"))
GLMER_model_GLE_Cerebellum_invgauss_log_1
car::Anova(GLMER_model_GLE_Cerebellum_invgauss_log_1, type=3)

GLMER_model_GLE_Cerebellum_invgauss_identity_1 <- glmer(Stimulus.RT ~ StimCondition + (1|Subject), data = GLE_Cerebellum, nAGQ = 0, family = inverse.gaussian(link = "identity"))
GLMER_model_GLE_Cerebellum_invgauss_identity_1
car::Anova(GLMER_model_GLE_Cerebellum_invgauss_identity_1, type=3)


GLMER_model_GLE_Cerebellum_gamma_log_2 <- glmer(Stimulus.RT ~ StimCondition*SessionNrSimplified + (1|Subject), data = GLE_Cerebellum, nAGQ = 0, family = Gamma(link = "log"))
GLMER_model_GLE_Cerebellum_gamma_log_2
car::Anova(GLMER_model_GLE_Cerebellum_gamma_log_2, type=3)

GLMER_model_GLE_Cerebellum_invgauss_log_2 <- glmer(Stimulus.RT ~ StimCondition*SessionNrSimplified + (1|Subject), data = GLE_Cerebellum, nAGQ = 0, family = inverse.gaussian(link = "log"))
GLMER_model_GLE_Cerebellum_invgauss_log_2
car::Anova(GLMER_model_GLE_Cerebellum_invgauss_log_2, type=3)

GLMER_model_GLE_Cerebellum_invgauss_identity_2 <- glmer(Stimulus.RT ~ StimCondition*SessionNrSimplified + (1|Subject), data = GLE_Cerebellum, nAGQ = 0, family = inverse.gaussian(link = "identity"))
GLMER_model_GLE_Cerebellum_invgauss_identity_2
car::Anova(GLMER_model_GLE_Cerebellum_invgauss_identity_2, type=3)


GLMER_model_GLE_Cerebellum_gamma_log_3 <- glmer(Stimulus.RT ~ StimCondition*SessionNrSimplified*Block + (1|Subject), data = GLE_Cerebellum, nAGQ = 0, family = Gamma(link = "log"))
GLMER_model_GLE_Cerebellum_gamma_log_3
car::Anova(GLMER_model_GLE_Cerebellum_gamma_log_3, type=3)

GLMER_model_GLE_Cerebellum_invgauss_log_3 <- glmer(Stimulus.RT ~ StimCondition*SessionNrSimplified*Block + (1|Subject), data = GLE_Cerebellum, nAGQ = 0, family = inverse.gaussian(link = "log"))
GLMER_model_GLE_Cerebellum_invgauss_log_3
car::Anova(GLMER_model_GLE_Cerebellum_invgauss_log_3, type=3)

GLMER_model_GLE_Cerebellum_invgauss_identity_3 <- glmer(Stimulus.RT ~ StimCondition*SessionNrSimplified*Block + (1|Subject), data = GLE_Cerebellum, nAGQ = 0, family = inverse.gaussian(link = "identity"))
GLMER_model_GLE_Cerebellum_invgauss_identity_3
car::Anova(GLMER_model_GLE_Cerebellum_invgauss_identity_3, type=3)


GLMER_model_GLE_Cerebellum_gamma_log_4 <- glmer(Stimulus.RT ~ StimCondition*SessionNrSimplified*poly(Block, 2) + (1|Subject), data = GLE_Cerebellum, nAGQ = 0, family = Gamma(link = "log"))
GLMER_model_GLE_Cerebellum_gamma_log_4
car::Anova(GLMER_model_GLE_Cerebellum_gamma_log_4, type=3)

GLMER_model_GLE_Cerebellum_invgauss_log_4 <- glmer(Stimulus.RT ~ StimCondition*SessionNrSimplified*poly(Block, 2) + (1|Subject), data = GLE_Cerebellum, nAGQ = 0, family = inverse.gaussian(link = "log"))
GLMER_model_GLE_Cerebellum_invgauss_log_4
car::Anova(GLMER_model_GLE_Cerebellum_invgauss_log_4, type=3)

GLMER_model_GLE_Cerebellum_invgauss_identity_4 <- glmer(Stimulus.RT ~ StimCondition*SessionNrSimplified*poly(Block, 2) + (1|Subject), data = GLE_Cerebellum, nAGQ = 0, family = inverse.gaussian(link = "identity"))
GLMER_model_GLE_Cerebellum_invgauss_identity_4
car::Anova(GLMER_model_GLE_Cerebellum_invgauss_identity_4, type=3)


anova(GLMER_model_GLE_Cerebellum_gamma_log_1,GLMER_model_GLE_Cerebellum_invgauss_log_1,GLMER_model_GLE_Cerebellum_invgauss_identity_1,
      GLMER_model_GLE_Cerebellum_gamma_log_2,GLMER_model_GLE_Cerebellum_invgauss_log_2,GLMER_model_GLE_Cerebellum_invgauss_identity_2,
      GLMER_model_GLE_Cerebellum_gamma_log_3,GLMER_model_GLE_Cerebellum_invgauss_log_3,GLMER_model_GLE_Cerebellum_invgauss_identity_3,
      GLMER_model_GLE_Cerebellum_gamma_log_4,GLMER_model_GLE_Cerebellum_invgauss_log_4,GLMER_model_GLE_Cerebellum_invgauss_identity_4)


# GLMER_model_GLE_Cerebellum_invgauss_log_4b = best fitting model, followed by GLMER_model_GLE_Cerebellum_invgauss_log_3b
# data seems to be consistently better represented by inverse gaussian than gamma distribution
# data seems to be better represented by inverse gaussian with log link than identity link

# Add random effects to the models

GLMER_model_GLE_Cerebellum_invgauss_log_5 <- glmer(Stimulus.RT ~ StimCondition*SessionNrSimplified*poly(Block,2) + (1 + poly(Block,2)|Subject), data = GLE_Cerebellum, nAGQ = 0, family = inverse.gaussian(link = "log"))
GLMER_model_GLE_Cerebellum_invgauss_log_5
car::Anova(GLMER_model_GLE_Cerebellum_invgauss_log_5, type=3)

GLMER_model_GLE_Cerebellum_invgauss_log_6 <- glmer(Stimulus.RT ~ StimCondition*SessionNrSimplified*poly(Block,2) + (1 + SessionNrSimplified|Subject), data = GLE_Cerebellum, nAGQ = 0, family = inverse.gaussian(link = "log"))
GLMER_model_GLE_Cerebellum_invgauss_log_6
car::Anova(GLMER_model_GLE_Cerebellum_invgauss_log_6, type=3)

GLMER_model_GLE_Cerebellum_invgauss_log_7 <- glmer(Stimulus.RT ~ StimCondition*SessionNrSimplified*poly(Block,2) + (1 + StimCondition|Subject), data = GLE_Cerebellum, nAGQ = 0, family = inverse.gaussian(link = "log"))
GLMER_model_GLE_Cerebellum_invgauss_log_7
car::Anova(GLMER_model_GLE_Cerebellum_invgauss_log_7, type=3)

GLMER_model_GLE_Cerebellum_invgauss_identity_5 <- glmer(Stimulus.RT ~ StimCondition*SessionNrSimplified*poly(Block,2) + (1 + poly(Block,2)|Subject), data = GLE_Cerebellum, nAGQ = 0, family = inverse.gaussian(link = "identity"))
GLMER_model_GLE_Cerebellum_invgauss_identity_5
car::Anova(GLMER_model_GLE_Cerebellum_invgauss_identity_5, type=3)

GLMER_model_GLE_Cerebellum_invgauss_identity_6 <- glmer(Stimulus.RT ~ StimCondition*SessionNrSimplified*poly(Block,2) + (1 + SessionNrSimplified|Subject), data = GLE_Cerebellum, nAGQ = 0, family = inverse.gaussian(link = "identity"))
GLMER_model_GLE_Cerebellum_invgauss_identity_6
car::Anova(GLMER_model_GLE_Cerebellum_invgauss_identity_6, type=3)

GLMER_model_GLE_Cerebellum_invgauss_identity_7 <- glmer(Stimulus.RT ~ StimCondition*SessionNrSimplified*poly(Block,2) + (1 + StimCondition|Subject), data = GLE_Cerebellum, nAGQ = 0, family = inverse.gaussian(link = "identity"))
GLMER_model_GLE_Cerebellum_invgauss_identity_7
car::Anova(GLMER_model_GLE_Cerebellum_invgauss_identity_7, type=3)

anova(GLMER_model_GLE_Cerebellum_gamma_log_1,GLMER_model_GLE_Cerebellum_invgauss_log_1,GLMER_model_GLE_Cerebellum_invgauss_identity_1,
      GLMER_model_GLE_Cerebellum_gamma_log_2,GLMER_model_GLE_Cerebellum_invgauss_log_2,GLMER_model_GLE_Cerebellum_invgauss_identity_2,
      GLMER_model_GLE_Cerebellum_gamma_log_3,GLMER_model_GLE_Cerebellum_invgauss_log_3,GLMER_model_GLE_Cerebellum_invgauss_identity_3,
      GLMER_model_GLE_Cerebellum_gamma_log_4,GLMER_model_GLE_Cerebellum_invgauss_log_4,GLMER_model_GLE_Cerebellum_invgauss_identity_4,
      GLMER_model_GLE_Cerebellum_invgauss_log_5,GLMER_model_GLE_Cerebellum_invgauss_identity_5,
      GLMER_model_GLE_Cerebellum_invgauss_log_6,GLMER_model_GLE_Cerebellum_invgauss_identity_6,
      GLMER_model_GLE_Cerebellum_invgauss_log_7,GLMER_model_GLE_Cerebellum_invgauss_identity_7)

# data seems to be better represented by inverse gaussian with log link than identity link
# Add more complex random effects to the models


GLMER_model_GLE_Cerebellum_invgauss_log_8 <- glmer(Stimulus.RT ~ StimCondition*SessionNrSimplified*poly(Block,2) + (1 + SessionNrSimplified + poly(Block,2)|Subject), data = GLE_Cerebellum, nAGQ = 0, family = inverse.gaussian(link = "log"))
GLMER_model_GLE_Cerebellum_invgauss_log_8
car::Anova(GLMER_model_GLE_Cerebellum_invgauss_log_8, type=3)

GLMER_model_GLE_Cerebellum_invgauss_log_9 <- glmer(Stimulus.RT ~ StimCondition*SessionNrSimplified*poly(Block,2) + (1 + StimCondition + poly(Block,2)|Subject), data = GLE_Cerebellum, nAGQ = 0, family = inverse.gaussian(link = "log"))
GLMER_model_GLE_Cerebellum_invgauss_log_9
car::Anova(GLMER_model_GLE_Cerebellum_invgauss_log_9, type=3)

GLMER_model_GLE_Cerebellum_invgauss_log_10 <- glmer(Stimulus.RT ~ StimCondition*SessionNrSimplified*poly(Block,2) + (1 + StimCondition + SessionNrSimplified|Subject), data = GLE_Cerebellum, nAGQ = 0, family = inverse.gaussian(link = "log"))
GLMER_model_GLE_Cerebellum_invgauss_log_10
car::Anova(GLMER_model_GLE_Cerebellum_invgauss_log_10, type=3)

# GLMER_model_GLE_Cerebellum_invgauss_identity_8 <- glmer(Stimulus.RT ~ StimCondition*SessionNrSimplified*poly(Block,2) + (1 + SessionNrSimplified + poly(Block,2)|Subject), data = GLE_Cerebellum, nAGQ = 0, family = inverse.gaussian(link = "identity"))
# GLMER_model_GLE_Cerebellum_invgauss_identity_8
# car::Anova(GLMER_model_GLE_Cerebellum_invgauss_identity_8, type=3)
# 
# GLMER_model_GLE_Cerebellum_invgauss_identity_9 <- glmer(Stimulus.RT ~ StimCondition*SessionNrSimplified*poly(Block,2) + (1 + StimCondition + poly(Block,2)|Subject), data = GLE_Cerebellum, nAGQ = 0, family = inverse.gaussian(link = "identity"))
# GLMER_model_GLE_Cerebellum_invgauss_identity_9
# car::Anova(GLMER_model_GLE_Cerebellum_invgauss_identity_9, type=3)
# 
# GLMER_model_GLE_Cerebellum_invgauss_identity_10 <- glmer(Stimulus.RT ~ StimCondition*SessionNrSimplified*poly(Block,2) + (1 + StimCondition + SessionNrSimplified|Subject), data = GLE_Cerebellum, nAGQ = 0, family = inverse.gaussian(link = "identity"))
# GLMER_model_GLE_Cerebellum_invgauss_identity_10
# car::Anova(GLMER_model_GLE_Cerebellum_invgauss_identity_10, type=3)


# Add more complex random effects to the models


GLMER_model_GLE_Cerebellum_invgauss_log_11 <- glmer(Stimulus.RT ~ StimCondition*SessionNrSimplified*poly(Block,2) + (1 + SessionNrSimplified*poly(Block,2)|Subject), data = GLE_Cerebellum, nAGQ = 0, family = inverse.gaussian(link = "log"))
GLMER_model_GLE_Cerebellum_invgauss_log_11
car::Anova(GLMER_model_GLE_Cerebellum_invgauss_log_11, type=3)

GLMER_model_GLE_Cerebellum_invgauss_log_12 <- glmer(Stimulus.RT ~ StimCondition*SessionNrSimplified*poly(Block,2) + (1 + StimCondition*poly(Block,2)|Subject), data = GLE_Cerebellum, nAGQ = 0, family = inverse.gaussian(link = "log"))
GLMER_model_GLE_Cerebellum_invgauss_log_12
car::Anova(GLMER_model_GLE_Cerebellum_invgauss_log_12, type=3)

GLMER_model_GLE_Cerebellum_invgauss_log_13 <- glmer(Stimulus.RT ~ StimCondition*SessionNrSimplified*poly(Block,2) + (1 + StimCondition*SessionNrSimplified|Subject), data = GLE_Cerebellum, nAGQ = 0, family = inverse.gaussian(link = "log"))
GLMER_model_GLE_Cerebellum_invgauss_log_13
car::Anova(GLMER_model_GLE_Cerebellum_invgauss_log_13, type=3)


# GLMER_model_GLE_Cerebellum_invgauss_identity_11 <- glmer(Stimulus.RT ~ StimCondition*SessionNrSimplified*poly(Block,2) + (1 + SessionNrSimplified*poly(Block,2)|Subject), data = GLE_Cerebellum, nAGQ = 0, family = inverse.gaussian(link = "identity"))
# GLMER_model_GLE_Cerebellum_invgauss_identity_11
# car::Anova(GLMER_model_GLE_Cerebellum_invgauss_identity_11, type=3)
# 
# GLMER_model_GLE_Cerebellum_invgauss_identity_12 <- glmer(Stimulus.RT ~ StimCondition*SessionNrSimplified*poly(Block,2) + (1 + StimCondition*poly(Block,2)|Subject), data = GLE_Cerebellum, nAGQ = 0, family = inverse.gaussian(link = "identity"))
# GLMER_model_GLE_Cerebellum_invgauss_identity_12
# car::Anova(GLMER_model_GLE_Cerebellum_invgauss_identity_12, type=3)
# 
# GLMER_model_GLE_Cerebellum_invgauss_identity_13 <- glmer(Stimulus.RT ~ StimCondition*SessionNrSimplified*poly(Block,2) + (1 + StimCondition*SessionNrSimplified|Subject), data = GLE_Cerebellum, nAGQ = 0, family = inverse.gaussian(link = "identity"))
# GLMER_model_GLE_Cerebellum_invgauss_identity_13
# car::Anova(GLMER_model_GLE_Cerebellum_invgauss_identity_13, type=3)
...
# GLMER_model_GLE_Cerebellum_invgauss_log_13 = best fit
...
# Set options to print all output
...
GLMER_model_GLE_Cerebellum_invgauss_log_13_emm1 <- emmeans(GLMER_model_GLE_Cerebellum_invgauss_log_13, pairwise ~ StimCondition*SessionNrSimplified*Block, var = "Block", type = "response")
GLMER_model_GLE_Cerebellum_invgauss_log_13_emm1

# Obtain slope estimates for the RTs across all Blocks
GLMER_model_GLE_Cerebellum_invgauss_log_13_emm2 <- emtrends(GLMER_model_GLE_Cerebellum_invgauss_log_13, pairwise ~ StimCondition*SessionNrSimplified*Block, var = "Block", type = "response")
GLMER_model_GLE_Cerebellum_invgauss_log_13_emm2


GLMER_model_GLE_Cerebellum_invgauss_log_13_emm3 <- emtrends(GLMER_model_GLE_Cerebellum_invgauss_log_13, pairwise ~ SessionNrSimplified*Block, var = "Block", type = "response")
GLMER_model_GLE_Cerebellum_invgauss_log_13_emm3


GLMER_model_GLE_Cerebellum_invgauss_log_13_emm4 <- emtrends(GLMER_model_GLE_Cerebellum_invgauss_log_13, pairwise ~ Block, type = "response")
GLMER_model_GLE_Cerebellum_invgauss_log_13_emm4

GLMER_model_GLE_Cerebellum_invgauss_log_13_emm4 <- emtrends(GLMER_model_GLE_Cerebellum_invgauss_log_13, pairwise ~ SessionNrSimplified, type = "response")
GLMER_model_GLE_Cerebellum_invgauss_log_13_emm4

GLMER_model_GLE_Cerebellum_invgauss_log_13_emm4 <- emmeans(GLMER_model_GLE_Cerebellum_invgauss_log_13, pairwise ~ SessionNrSimplified, type = "response")
GLMER_model_GLE_Cerebellum_invgauss_log_13_emm4

GLMER_model_GLE_Cerebellum_invgauss_log_13_emm5 <- emmeans(GLMER_model_GLE_Cerebellum_invgauss_log_13, pairwise ~ StimCondition, type = "response")
GLMER_model_GLE_Cerebellum_invgauss_log_13_emm5


# # To plot the quadratic impact of factor Block
GLMER_model_GLE_Cerebellum_invgauss_log_13_SPLINES <- ref_grid(GLMER_model_GLE_Cerebellum_invgauss_log_13, at = list(Block = seq(min(GLE_Cerebellum$Block), max(GLE_Cerebellum$Block), 1)), mode = "asymp", type = "response") 
GLMER_model_GLE_Cerebellum_invgauss_log_13_SPLINES
emmip(GLMER_model_GLE_Cerebellum_invgauss_log_13_SPLINES, ~Block, type = "response")
emmip(GLMER_model_GLE_Cerebellum_invgauss_log_13_SPLINES, ~Block*StimCondition, CIs = T, plotit = F, type = "response")
emmip(GLMER_model_GLE_Cerebellum_invgauss_log_13_SPLINES, StimCondition ~ Block | SessionNrSimplified, type = "response")

# Simple contrasts

contrast(GLMER_model_GLE_Cerebellum_invgauss_log_13_emm1, "pairwise", simple = "each")

# Interaction contrasts
IC_Group_Condition <- contrast(GLMER_model10_GLE_Conventional_M1_vs_HD_M1_invgauss_identity_converged_emm1, interaction = c("pairwise"), by = c("SessionNrSimplified", "Block"))
IC_Group_Condition

# Interaction contrasts
IC_Condition <- contrast(GLMER_model10_GLE_Conventional_M1_vs_HD_M1_invgauss_identity_converged_emm1, interaction = c("pairwise"), by = c("SessionNrSimplified"))
IC_Condition
...
# Extract estimated marginal means and confidence intervals
emm_data <- as_tibble(GLMER_model_GLE_Cerebellum_invgauss_log_13_SPLINES)
emm_pred <- predict(GLMER_model_GLE_Cerebellum_invgauss_log_13_SPLINES, type = "response", interval = "confidence")
...
# Create the plot
plot <- ggplot(data = plot_data, aes(x = Block, y = response, color = StimCondition)) +
  geom_line() +
  geom_errorbar(aes(ymin = asymp.LCL, ymax = asymp.UCL), width = 0.2) +
  geom_point() +
  facet_grid( ~ SessionNrSimplified, scales = "free_x", switch = "x") +
  labs(x = "Block", y = "Reaction Time (ms)") +
  theme_minimal()
...
# Create the plot
plot <- ggplot(data = plot_data, aes(x = Block, y = response, color = StimCondition, group = StimCondition)) +
  geom_errorbar(aes(ymin = asymp.LCL, ymax = asymp.UCL), width = 0.2, size = 1) +  # Increase line thickness
  geom_point(size = 1.5) +
  geom_line(aes(linetype = StimCondition), size = 1) +  # Connect the dots within each level of StimCondition
  facet_grid(. ~ SessionNrSimplified, scales = "free_x", space = "free_x") +
  labs(x = "", y = "") +
  scale_y_continuous(breaks = seq(0, max(plot_data$response), by = 20)) +
  theme_bw() +
  theme(panel.grid.major.x = element_blank(),  # Remove default vertical gridlines
        panel.grid.major.y = element_line(color = "gray", linetype = "solid"))  # Add horizontal gridlines

# Adjust x-axis labels
plot <- plot + scale_x_discrete(labels = function(x) gsub("interaction\\((.*?),\\s(.*?)\\)", "\\2 - \\1", x)) +
  theme(axis.text.x = element_text(size = 8))  # Adjust the font size of x-axis labels

# Add vertical gridlines per level of Block
plot <- plot + geom_vline(xintercept = seq_along(unique(plot_data$Block)), color = "gray", linetype = "solid")
